...
import com.sicsix.personalisedlearning.models.HistoryResponse
...
import com.sicsix.personalisedlearning.models.StatsResponse
...
interface Api {
    ...
    @PUT("/userbilling")
    suspend fun updateUserBilling(@Header("Authorization") token: String, @Body plan: UserPlan): Response<LoginResponse>

    @GET("/history/all")
    suspend fun getHistory(@Header("Authorization") token: String): Response<HistoryResponse>

    @GET("/history/correct")
    suspend fun getCorrectHistory(@Header("Authorization") token: String): Response<HistoryResponse>

    @GET("/history/incorrect")
    suspend fun getIncorrectHistory(@Header("Authorization") token: String): Response<HistoryResponse>
}